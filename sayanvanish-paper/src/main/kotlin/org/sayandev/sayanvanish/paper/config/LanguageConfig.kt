...
data class LanguageConfig(
    ...
    @Serializable
    data class Paste(
        val use: String = "<gray>Your paste key is <gold><key></gold>, <red>Make sure to check the content before sharing it with others and remove the data you don't want to share. <white><click:open_url:'<url>'>(Click to open paste)</click>",
